...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-br8-check-has-services', 'application-br8-check-has-services', 'sql', 'An application must have at least one service::::Заявление должно иметь хотя бы одну услугу.::::الطلب يجب ان يحتوي على خدمة واحدة على الاقل.::::La demande doit contenir au moins un service::::::::::::O pedido deve ter pelo menos um serviço::::::::每次应用必须提供至少一次服务', NULL, 'Checks that an application has at least one service. When this rule fails you should add a service to the application or cancel the application.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('app-allowable-primary-right-for-new-title', 'app-allowable-primary-right-for-new-title', 'sql', 'An allowable primary right (ownership, apartment, State ownership, lease) must be identified for a new title::::Одно из допустимых прав собственности такое как - право собственности, право собственности на квартиру, государственное право собственности, аренда, должно быть зарегистрировано для нового объекта недвижимости.::::الحق الاساسي المسموح به  (المالك, الشقة, مالك العقار, الايجار ) يجب تحديده لسند ملكية جديد::::Tous les droits principaux autorisés (propriété, appartement, propriété de l''Etat, bail) doivent être identifiés pour le nouveau titre::::::::::::Um direito fundamental (propriedade, apartamento, propriedade do Estado, arrendamento) deve ser identificado por um novo título::::::::一项受允许的基本权利(所有权、公寓住址、国有产权以及租赁等) 必须作为新的产权被确定。', NULL, '#{id}(application.application.id) is requested');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('generate-spatial-unit-group-name', 'generate-spatial-unit-group-name', 'sql', '', NULL, 'It accepts parameters: 
  ...
  #{label_v} = The label
  ');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-spatial-unit-not-transferred', 'application-spatial-unit-not-transferred', 'sql', 'An application must not use a parcel already transferred.::::::::::::::::::::::::Um pedido não deve usar uma parcela já transferida.::::::::一个申请不适用于已转移的宗地。', NULL, 'It checks if the application has no spatial_unit that is already targeted by an application that has the status  transferred.');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('required-sources-are-present', 'required-sources-are-present', 'sql', 'All documents required for the service ''req_type'' are present.::::Должны присутствовать все документы необходимые для услуги ''req_type'' .::::جميع الوثائق المطلوبة لخدمة  ''req_type''  موجودة::::Tous les documents requis pour le service ''req_type'' sont présents.::::::::::::Todos os documentos necessários para o ''req_type'' estão presentes.::::::::所有需要作为服务 ''req_type'' 的文件都要呈现。', NULL, 'Checks that all required documents for any of the services in an application are recorded. Null value is returned if there are no required documents');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('new-cadastre-objects-do-not-overlap', 'new-cadastre-objects-do-not-overlap', 'sql', 'The new parcel polygons must not overlap::::Новые участки не должны пересекаться.::::مضلعات القطعة الجديدة يجب ان لا تتداخل::::Les polygones des nouvelles parcelles ne doivent pas se superposer.::::::::::::Os polígonos das novas parcelas não devem se sobrepor.::::::::新宗地多边形不能较差。', NULL, '#{id}(transaction_id) is requested. Check the union of new co has the same area as the sum of all areas of new co-s, which means the new co-s don''t overlap');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('spatial-unit-group-name-unique', 'spatial-unit-group-name-unique', 'sql', 'Spatial unit groups must be unique.::::Пространственные группы должны быть уникальны.::::::::::::::::::::Grupo de unidade espacial deves ser único.::::::::空间单元组必须是独一无二的。', NULL, 'There is no parameter required.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('bulk-spatial-geom-overlaps-with-loading-geom', 'bulk-spatial-geom-overlaps-with-loading-geom', 'sql', 'New cadastre objects must not overlap with other new cadastre objects. ::::Новые кадастровые объекты не должны пересекаться с другими новыми объектами.::::::::::::::::::::Novo cadastro de objetos não deve se sobrepor com novo cadastro de objetos existentes.::::::::新的地籍目标不能与其他新的地籍目标相交叠。 ', NULL, '#{id}(transaction_id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('spatial-unit-group-not-overlap', 'spatial-unit-group-not-overlap', 'sql', 'Spatial unit groups of the same hierarchy must not overlap with each other. Tolerance of 0.5 m is applied.::::Пространственные группы одной и той же иерархии не должны пересекаться друг с другом. Погрешность не должна превышать 0.5 м::::::::::::::::::::Grupos de unidade espaciais com a mesma hierarquia, não devem ser sobrepor uns com os outros. A tolerância aplicada é de 0.5 m.::::::::同一层次的空间单元组不能与其他的相交。适用限度是0.5米。', NULL, 'There is no parameter required.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-not-transferred', 'application-not-transferred', 'sql', 'An application should not be already transferred to another system.::::::::::::::::::::::::O pedido ainda não deve ser transferido para outro sistema.::::::::一项申请不应该被已转移成另一个系统。', NULL, 'The application should not have the status transferred.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('bulk-spatial-geom-overlaps-with-existing', 'bulk-spatial-geom-overlaps-with-existing', 'sql', 'Cadastre objects must not overlap with existing cadastre objects. ::::Кадастровые объекты не должны пересекаться с существующими кадастровыми объектами.::::::::::::::::::::Cadastro de objetos não deve se sobrepor com cadastro de objetos existentes.::::::::地籍目标必须不能与现有的地籍目标相交叠。', NULL, '#{id}(transaction_id) is requested');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-caveat', 'ba_unit-has-caveat', 'sql', 'Caveat should not prevent registration proceeding.::::Арест не должен ограничивать дальнейшую регистрацию.::::القيود لا يجب ان تعطل عملية التسجيل::::Un caveat ne doit pas empêcher de procéder à l''enregistrement.::::::::::::Advertência não deve impedir de prosseguir a inscrição.::::::::警告不应阻止登记的进行。', NULL, '#{id}(administrative.rrr.id) is requested.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('source-attach-in-transaction-allowed-type', 'source-attach-in-transaction-allowed-type', 'sql', 'Document to be registered must have an allowable and current source type::::Документы для регистрации должны иметь допустимый тип.::::الوثيقة المراد تسجيلها يجب ان يكون لها نوع مصدر حالي مسموح به::::Le document à enregistrer doit avoir un type de source courant et disponible.::::::::::::Documento a ser registrado deve ter um tipo de fonte admissível e atual::::::::待登记的文件必须具有可允许的现状来源类型。', NULL, '#{id}(source.source.id) is requested. It checks if the source has a type which has the is_for_registration attribute true.');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-br3-check-properties-are-not-historic', 'application-br3-check-properties-are-not-historic', 'sql', 'All the titles identified for the application must be current.::::Все права собственности, относящиеся к заявлению должны иметь текущий (активный) статус.::::جميع سندات الملكية داخل الطلب يجب ان  تكون حالية::::Tous les titres identifiés pour la demande doivent être courants.::::::::::::Todos os títulos identificados para o pedido devem ser atuais.::::::::所有标志为应用的产权都必须是当下的。', NULL, 'Checks the title reference recorded at lodgement against titles in the database and if there is a ba_unit record it checks if it is current (PASS)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('consolidation-extraction-file-name', 'Consolidation extraction file name', 'sql', '111.0', 'Generates the name of the extraction file for the consolidation. The extension is not part of this generation.', '');
