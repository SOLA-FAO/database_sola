...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-spatial-unit-not-transferred', 'application-spatial-unit-not-transferred', 'sql', 'An application must not use a parcel already transferred.::::::::::::::::::::::::Um pedido não deve usar uma parcela já transferida.::::::::一项申请不适用于已转让的宗地。', NULL, 'It checks if the application has no spatial_unit that is already targeted by an application that has the status  transferred.');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('source-attach-in-transaction-allowed-type', 'source-attach-in-transaction-allowed-type', 'sql', 'Document to be registered must have an allowable and current source type::::Документы для регистрации должны иметь допустимый тип.::::الوثيقة المراد تسجيلها يجب ان يكون لها نوع مصدر حالي مسموح به::::Le document à enregistrer doit avoir un type de source courant et disponible.::::::::::::Documento a ser registrado deve ter um tipo de fonte admissível e atual::::::::待登记的文件必须具有许可的现状来源类型。', NULL, '#{id}(source.source.id) is requested. It checks if the source has a type which has the is_for_registration attribute true.');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-caveat', 'ba_unit-has-caveat', 'sql', 'Caveat should not prevent registration proceeding.::::Арест не должен ограничивать дальнейшую регистрацию.::::القيود لا يجب ان تعطل عملية التسجيل::::Un caveat ne doit pas empêcher de procéder à l''enregistrement.::::::::::::Advertência não deve impedir de prosseguir a inscrição.::::::::产权的附加权利不应阻止登记的进行。', NULL, '#{id}(administrative.rrr.id) is requested.');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('cancel-relation-notification', '5c93e7ba-bce3-11e4-9033-6300da0026fa', 'sql', 'Cancel notification for the services of the application', NULL, '#{id}(application_id) is requested');
...
INSERT INTO br_validation (id, br_id, target_code, target_application_moment, target_service_moment, target_reg_moment, target_request_type_code, target_rrr_type_code, severity_code, order_of_execution) VALUES ('c7aff44e-c0cb-11e4-a5ef-03304363f8ad', 'cancel-obscuration-request', 'service', NULL, 'cancel', NULL, NULL, NULL, 'warning', 310);
INSERT INTO br_validation (id, br_id, target_code, target_application_moment, target_service_moment, target_reg_moment, target_request_type_code, target_rrr_type_code, severity_code, order_of_execution) VALUES ('782ccc8a-c0d5-11e4-8af7-e7e64e31045c', 'application-cancel-obscuration-request', 'application', 'cancel', NULL, NULL, NULL, NULL, 'warning', 320);
INSERT INTO br_validation (id, br_id, target_code, target_application_moment, target_service_moment, target_reg_moment, target_request_type_code, target_rrr_type_code, severity_code, order_of_execution) VALUES ('782c575a-c0d5-11e4-a962-6fdf878ae759', 'application-cancel-obscuration-request', 'application', 'withdraw', NULL, NULL, NULL, NULL, 'warning', 330);
INSERT INTO br_validation (id, br_id, target_code, target_application_moment, target_service_moment, target_reg_moment, target_request_type_code, target_rrr_type_code, severity_code, order_of_execution) VALUES ('782d68ca-c0d5-11e4-ac6a-fb96119e62f7', 'application-cancel-obscuration-request', 'application', 'requisition', NULL, NULL, NULL, NULL, 'warning', 340);
