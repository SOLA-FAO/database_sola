...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('bulk-spatial-geom-overlaps-with-loading-geom', 'bulk-spatial-geom-overlaps-with-loading-geom', 'sql', 'New cadastre objects must not overlap with other new cadastre objects. ::::Новые кадастровые объекты не должны пересекаться с другими новыми объектами.::::الكينونات المساحية الجديدة لا يجب ان تتداخل مع كينونات مساحة  جديدة أخرى::::::::::::::::Novos objetos de cadastro não devem se sobrepor com novos objetos de cadastro.::::::::新的地籍目标不能与其他新的地籍目标相交叠。 ', NULL, '#{id}(transaction_id) is requested');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-caveat', 'ba_unit-has-caveat', 'sql', 'Caveat should not prevent registration proceeding.::::Арест не должен ограничивать дальнейшую регистрацию.::::القيود لا يجب ان تعطل عملية التسجيل::::Un caveat ne doit pas empêcher de procéder à l''enregistrement.::::::::::::Enbargo não deve impedir de prosseguir a inscrição.::::::::附加权利不应阻止登记的进行。', NULL, '#{id}(administrative.rrr.id) is requested.');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-br1-check-required-sources-are-present', 'application-br1-check-required-sources-are-present', 'sql', 'All documents required for the services in this application are present.::::Все документы, необходимые для указанных услуг должны присутствовать в заявлении.::::جميع الوثائق المطلوبة للخدمة  موجودة::::Tous les documents requis pour les services de cette demande sont présents.::::::::::::Todos os documentos necessários para os serviços neste pedido estão presentes.::::::::申请中需要的所有文件都需要呈上。', NULL, 'Checks that all required documents for any of the services in an application are recorded. Null value is returned if there are no required documents');
