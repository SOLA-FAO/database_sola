...
insert into system.setting (name, active, vl, description) values ('email-msg-user-registration-subject', 't', 'New user registration', 'Subject text for new user registration on OpenTenure Web-site. Sent to administrator.');
insert into system.setting (name, active, vl, description) values ('email-msg-user-registration-body', 't', 'New user "#{userName}" has been registered registered on SOLA OpenTenure Web-site.', 'Message text for new user registration on OpenTenure Web-site');
