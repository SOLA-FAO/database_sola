...
--
-- Name: claimant_gender_code_fk13; Type: FK CONSTRAINT; Schema: opentenure; Owner: postgres
--

ALTER TABLE ONLY claimant
    ADD CONSTRAINT claimant_gender_code_fk13 FOREIGN KEY (gender_code) REFERENCES party.gender_type(code);


--
-- Name: claimant_id_type_code_fk12; Type: FK CONSTRAINT; Schema: opentenure; Owner: postgres
--

ALTER TABLE ONLY claimant
    ADD CONSTRAINT claimant_id_type_code_fk12 FOREIGN KEY (id_type_code) REFERENCES party.id_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
